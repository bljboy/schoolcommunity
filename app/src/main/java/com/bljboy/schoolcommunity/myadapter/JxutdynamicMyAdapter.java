...
public class JxutdynamicMyAdapter extends RecyclerView.Adapter<JxutdynamicMyAdapter.MyHolder> {
    private Context context;
    private List<list> list;
    private ShapeableImageView shapeableImageView;

    public JxutdynamicMyAdapter(Context context) {
...
//        this.list = list;
    ...
    @NonNull
    @Override
    public JxutdynamicMyAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull JxutdynamicMyAdapter.MyHolder holder, int position) {
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        public MyHolder(@NonNull View itemView) {
            ...
            jxutnews_title.setText("6666666666666666666");
//            shapeableImageView =
