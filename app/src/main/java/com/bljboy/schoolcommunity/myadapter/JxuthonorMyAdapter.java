...
public class JxuthonorMyAdapter extends RecyclerView.Adapter<JxuthonorMyAdapter.MyHolder> {
    private Context context;
    private List<list> list;
    private ShapeableImageView shapeableImageView;

    public JxuthonorMyAdapter(Context context) {
...
//        this.list = list;
    ...
    @NonNull
    @Override
    public JxuthonorMyAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull JxuthonorMyAdapter.MyHolder holder, int position) {
